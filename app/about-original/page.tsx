...
import { AboutOriginalPage } from "@/components/about/AboutPages";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: buildAbsoluteUrl("/about-original")
  },
  openGraph: {
    title: "About Teleflora - Our Company & Contact Information | Teleflora",
    description: "Want to know more about Teleflora and our great floral products? Browse this page to learn more about our company.",
    url: buildAbsoluteUrl("/about-original"),
    siteName: "Teleflora",
...
export default function OriginalAboutRoute() {
  return (
    <>
